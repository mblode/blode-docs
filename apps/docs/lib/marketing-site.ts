...
export const MARKETING_SKILLS_INDEX_PATH = "/.well-known/agent-skills/index.json";
export const MARKETING_MCP_SERVER_CARD_PATH = "/.well-known/mcp/server-card.json";
